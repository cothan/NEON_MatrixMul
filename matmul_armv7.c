...
// Correct with N = 4, 8, 12, 16, 20, 24, 28, 32, 36
// gcc matmul.c -o matmul -O3  -g3 -mcpu=cortex-a9 -mfloat-abi=hard -mfpu=neon -DN=32 -DCOMPRESS=0
#define N 8
#define MAXRAND 8
#ifndef DEBUG
#define DEBUG 0
...
void neonMatMul_base(u16 A[], u16 B[], u16 C[])
{
    ...
    vload_half(va[0].val[0], &A[0 * N]);
    vload_half(va[0].val[1], &A[0 * N + 4]);
    vload_half(va[0].val[2], &A[1 * N]);
    vload_half(va[0].val[3], &A[1 * N + 4]);

    vload_half(va[1].val[0], &A[2 * N]);
    vload_half(va[1].val[1], &A[2 * N + 4]);
    vload_half(va[1].val[2], &A[3 * N]);
    vload_half(va[1].val[3], &A[3 * N + 4]);

    vload_half(va[2].val[0], &A[4 * N]);
    vload_half(va[2].val[1], &A[4 * N + 4]);
    vload_half(va[2].val[2], &A[5 * N]);
    vload_half(va[2].val[3], &A[5 * N + 4]);

    vload_half(va[3].val[0], &A[6 * N]);
    vload_half(va[3].val[1], &A[6 * N + 4]);
    vload_half(va[3].val[2], &A[7 * N]);
    vload_half(va[3].val[3], &A[7 * N + 4]);
#else
...
#if DEBUG
    print_vector_half(va[0]);
    print_vector_half(va[1]);
    print_vector_half(va[2]);
    print_vector_half(va[3]);
    ...
    for (int i = 0; i < 4; i += 2)
    {
        vmlalane(vc1.val[i], vb1.val[0], va[i / 2].val[0], 0);
        vmlalane(vc1.val[i], vb1.val[1], va[i / 2].val[0], 1);
        vmlalane(vc1.val[i], vb1.val[2], va[i / 2].val[0], 2);
        vmlalane(vc1.val[i], vb1.val[3], va[i / 2].val[0], 3);

        vmlalane(vc1.val[i], vb2.val[0], va[i / 2].val[1], 0);
        vmlalane(vc1.val[i], vb2.val[1], va[i / 2].val[1], 1);
        vmlalane(vc1.val[i], vb2.val[2], va[i / 2].val[1], 2);
        vmlalane(vc1.val[i], vb2.val[3], va[i / 2].val[1], 3);

        vmlalane(vc1.val[i + 1], vb1.val[0], va[i / 2].val[2], 0);
        vmlalane(vc1.val[i + 1], vb1.val[1], va[i / 2].val[2], 1);
        vmlalane(vc1.val[i + 1], vb1.val[2], va[i / 2].val[2], 2);
        vmlalane(vc1.val[i + 1], vb1.val[3], va[i / 2].val[2], 3);

        vmlalane(vc1.val[i + 1], vb2.val[0], va[i / 2].val[3], 0);
        vmlalane(vc1.val[i + 1], vb2.val[1], va[i / 2].val[3], 1);
        vmlalane(vc1.val[i + 1], vb2.val[2], va[i / 2].val[3], 2);
        vmlalane(vc1.val[i + 1], vb2.val[3], va[i / 2].val[3], 3);
    }
    for (int i = 0; i < 4; i += 2)
    {
        vmlalane(vc2.val[i], vb1.val[0], va[2 + i / 2].val[0], 0);
        vmlalane(vc2.val[i], vb1.val[1], va[2 + i / 2].val[0], 1);
        vmlalane(vc2.val[i], vb1.val[2], va[2 + i / 2].val[0], 2);
        vmlalane(vc2.val[i], vb1.val[3], va[2 + i / 2].val[0], 3);

        vmlalane(vc2.val[i], vb2.val[0], va[2 + i / 2].val[1], 0);
        vmlalane(vc2.val[i], vb2.val[1], va[2 + i / 2].val[1], 1);
        vmlalane(vc2.val[i], vb2.val[2], va[2 + i / 2].val[1], 2);
        vmlalane(vc2.val[i], vb2.val[3], va[2 + i / 2].val[1], 3);

        vmlalane(vc2.val[i + 1], vb1.val[0], va[2 + i / 2].val[2], 0);
        vmlalane(vc2.val[i + 1], vb1.val[1], va[2 + i / 2].val[2], 1);
        vmlalane(vc2.val[i + 1], vb1.val[2], va[2 + i / 2].val[2], 2);
        vmlalane(vc2.val[i + 1], vb1.val[3], va[2 + i / 2].val[2], 3);

        vmlalane(vc2.val[i + 1], vb2.val[0], va[2 + i / 2].val[3], 0);
        vmlalane(vc2.val[i + 1], vb2.val[1], va[2 + i / 2].val[3], 1);
        vmlalane(vc2.val[i + 1], vb2.val[2], va[2 + i / 2].val[3], 2);
        vmlalane(vc2.val[i + 1], vb2.val[3], va[2 + i / 2].val[3], 3);
    }
#else
